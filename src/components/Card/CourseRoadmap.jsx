      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Follow a structured learning path designed to take you from beginner to advanced level
          </p>
        </div>
        ...
        <div style={{
          ...
          <p style={{
            ...
            We're crafting a comprehensive step-by-step learning path with milestones, 
            projects, and skill assessments to guide your journey.
          </p>
